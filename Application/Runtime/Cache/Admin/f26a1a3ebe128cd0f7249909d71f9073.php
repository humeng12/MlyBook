            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/MlyBook/index.php/Admin/WeiXin/add" class="layui-btn layui-btn-normal"><i class="icon-font"></i>新增书籍</a>
                    </div>
                </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($tasks)): $i = 0; $__LIST__ = $tasks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>                         
                            ...
                            <td>
                                 <a class="layui-btn layui-btn-normal layui-btn-mini" href="/MlyBook/index.php/Admin/WeiXin/edit/id/<?php echo ($vo["id"]); ?>">详情</a>
                                 <a class="layui-btn layui-btn-mini" href="/MlyBook/index.php/Admin/WeiXin/chapter/id/<?php echo ($vo["id"]); ?>">添加章节</a>
                            </td>
