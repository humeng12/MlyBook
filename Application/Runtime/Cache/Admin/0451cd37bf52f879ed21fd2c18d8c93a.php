            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/Book/index.php/Admin/Message/bdel" type="submit" class="btn btn-primary btn2" value="批量删除" /></a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/Book/index.php/Admin/Message/reply/id/<?php echo ($vo["id"]); ?>">回复</a>
                                <a class="link-update" href="/Book/index.php/Admin/Message/checked/id/<?php echo ($vo["id"]); ?>">审核</a>
                                <a class="link-del" onclick="return confirm('确定删除此链接吗？');" href="/Book/index.php/Admin/Message/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
