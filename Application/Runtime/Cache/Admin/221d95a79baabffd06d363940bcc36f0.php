                        ...
                        <table class="insert-tab" width="100%">
                            <tbody>                         
                                <tr>
                                    ...
                                    <td>
                                        <i class="require-red"><?php echo ($title["title"]); ?></i>
                                    </td>
                                </tr>
                                 <tr>
                                    <th><i class="require-red">*</i>第几章：</th>
                                    <td>
                                        <input class="common-text" name="chapter" size="50" value="<?php echo ($chapterNum["chapter"]); ?>" type="text"/>
                                        <span style="color: #FFC125;">输入格式：如输入1代表第一章</span>
                                        <div style="margin-left: 10px;">
                                            <span style="color: #FF6A6A;">请注意:已输入了 第<?php echo ($chapterNum["chapter"]); ?>章:第<?php echo ($sectionNum["section"]); ?>节 的内容</span>
                                        </div>
                                    </td>
                                </tr>
                                 <tr>
                                    ...
                                    <td>
                                        <input class="common-text" name="section" size="50" value="<?php echo ($nextSecNum); ?>" type="text"/>
                                        <span style="color: #FFC125;">输入格式：如输入1代表第一节</span>
                                    </td>
                                </tr>
                                 <tr>
